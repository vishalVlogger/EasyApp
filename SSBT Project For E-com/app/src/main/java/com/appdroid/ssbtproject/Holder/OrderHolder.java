...
public class OrderHolder implements Serializable {
    Date orderDate,assignDate,deliveryDate;
    ...
    public OrderHolder(Date orderDate, Date assignDate, Date deliveryDate, String orderId, String status, String userNo, String docID, String deliveryBoyDocId, String deliveryBoyName, String deliveryBoyNo, String cancellationReason, String orderCancelBy, int orderTotal, List<OrderProductHolder> productDetails, OrderUserHolder userInfo) {
